...
function Footer() {
  ...
  return (
    <div className=" p-20 font-poppins max-[769px]:text-xs max-[480px]:p-5">
      <div className="border-t-1 border-b-1 flex border-gray-400 justify-between items-start p-5 max-[480px]:flex-wrap max-[480px]:gap-5 max-[480px]:p-10 ">
